...
const ScrollableComponent: React.FC<IScrollableComponentProps> = (
  ...
  return (
    <div
      ref={ref}
      className={clsx("scrollable-component", props.className)}
      id={props.id}
...
const Pin: React.FC = () => {
  const { userStatus, setUserStatusTo } = useAppContext();
...
const Weather: React.FC = () => {
  const getDays = (): React.ReactElement[] => {
    return [
      {
        id: 1,
        name: "Mon",
...
const Tools: React.FC = () => {
  const getTools = (): React.ReactElement[] => {
    return [
      {
        icon: "fa-solid fa-cloud-sun",
        id: 1,
        image:
          "https://images.unsplash.com/photo-1492011221367-f47e3ccd77a0?auto=format&fit=crop&w=500&q=60",
        label: "Weather",
        name: "Cloudly",
      },
      {
        ...
        id: 2,
        image:
          "https://images.unsplash.com/photo-1587145820266-a5951ee6f620?auto=format&fit=crop&w=500&q=60",
        label: "Calc",
        name: "Mathio",
      },
      {
        ...
        id: 3,
        image:
          "https://images.unsplash.com/photo-1579621970588-a35d0e7ab9b6?auto=format&fit=crop&w=500&q=60",
        label: "Bank",
        name: "Cashy",
      },
      {
        ...
        id: 4,
        image:
          "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=500&q=60",
        label: "Travel",
        name: "Fly-er-io-ly",
      },
      {
        ...
        id: 5,
        image:
          "https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?auto=format&fit=crop&w=500&q=60",
        label: "Games",
        name: "Gamey",
      },
      {
        ...
        id: 6,
        image:
          "https://images.unsplash.com/photo-1578022761797-b8636ac1773c?auto=format&fit=crop&w=500&q=60",
        label: "Video Chat",
        name: "Chatty",
      },
    ].map((tool: any) => {
      ...
      return (
        <div key={tool.id} className="tool-card">
          ...
          <div className="tool-card-content">
            ...
            <i className={clsx(tool.icon, "tool-card-icon")} />
          </div>
        </div>
      );
    });
...
const Restaurants: React.FC = () => {
  const getRestaurants = (): React.ReactElement[] => {
    return [
      {
        desc: "The best burgers in town",
        id: 1,
        image:
          "https://images.unsplash.com/photo-1606131731446-5568d87113aa?auto=format&fit=crop&w=500&q=60",
        title: "Burgers",
      },
      {
        ...
        id: 2,
        image:
          "https://images.unsplash.com/photo-1576506295286-5cda18df43e7?auto=format&fit=crop&w=500&q=60",
        title: "Ice Cream",
      },
      {
        ...
        id: 3,
        image:
          "https://images.unsplash.com/photo-1590947132387-155cc02f3212?auto=format&fit=crop&w=500&q=60",
        title: "Pizza",
      },
      {
...
const Movies: React.FC = () => {
  const getMovies = (): React.ReactElement[] => {
    return [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1596727147705-61a532a659bd?auto=format&fit=crop&w=500&q=60",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1535666669445-e8c15cd2e7d9?auto=format&fit=crop&w=500&q=60",
        title: "Hole People",
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1632266484284-a11d9e3a460a?auto=format&fit=crop&w=500&q=60",
        title: "Pot of Hair",
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1533613220915-609f661a6fe1?auto=format&fit=crop&w=500&q=60",
        title: "Area Fights",
      },
    ].map((movie: any) => {
      const styles: React.CSSProperties = {
